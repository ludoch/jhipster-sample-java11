package com.google.appengine.jhipster.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.google.appengine.jhipster.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.google.appengine.jhipster.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
